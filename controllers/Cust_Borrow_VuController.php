...
/**
 * Cust_Borrow_Vu Page Controller
 * @category  Controller
 */
class Cust_Borrow_VuController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$records = $db->get('cust_borrow_vu', $limit, $fields);
		...
		$this->view->page_title =get_lang('cust_borrow_vu_list_title');
		$this->view->render('cust_borrow_vu/list.php' , $data ,'main_layout.php');
