                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('emp_payments_list_emp_id_title'); ?> :</th>
                                        <td class="value">
                                            <a size="sm" class="btn btn-sm btn-primary page-modal" href="<?php print_link("employees/View/id/$data[emp_id]") ?>">
                                                <?php echo $data['emp_id']; ?>  <i class="material-icons">visibility</i>
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('emp_salaries_list_s_date_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['s_date']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("emp_salaries/edit/$data[id]"); ?>">
