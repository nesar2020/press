            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        ?>
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("emp_salaries/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input  id="s_date" class="form-control datepicker" required="" value="<?php  echo $data['s_date']; ?>" type="datetime" name="s_date" placeholder="<?php print_lang('emp_salaries_add_s_date_placeholder'); ?>" data-enable-time="false"   data-date-format="Y-m" data-alt-format="F , Y" data-inline="false" data-no-calendar="false" data-mode="single" />
