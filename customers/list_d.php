        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title"><?php echo " فروشات مختلف "; ?></h3>
                    ...
                    <div  class="card animated fadeIn" style="padding:5px;">
                        ...
                        <div class="page-records ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <a class="btn btn-sm btn-outline-info "  href="<?php print_link('ctp_orders/ctpwithid_d/'.$record['id']); ?>">
                                        CTP
                                    </a>
                                    <a class="btn btn-sm btn-outline-info " href="<?php print_link('flex_orders/flexwithid_d/'.$record['id']); ?>">
                                        دیجیتل
                                    </a>
                                    <a class="btn btn-sm btn-outline-info "  href="<?php print_link('paper_orders/paperwithid_d/'.$record['id']); ?>">
                                        کاغذ
                                    </a>
                                    <a class="btn btn-md btn-outline-primary"  href="<?php print_link("cust_payments/cust_list_d/"); ?>">
                                        <i class="material-icons"></i>رسیدات
                                    </a>
                                    <a class="btn btn-md btn-outline-primary"  href="<?php print_link("ctp_orders/cust_list_d/".$record['id']); ?>">
                                        <i class="material-icons"></i>فرمایش های  CTP
                                    </a>
                                    <a class="btn btn-md btn-outline-primary"  href="<?php print_link("flex_orders/cust_list_d/".$record['id']); ?>">
                                        <i class="material-icons"></i>فرمایش های دیجیتل
                                    </a>
                                    <a class="btn btn-md btn-outline-primary"  href="<?php print_link("paper_orders/cust_list_d/".$record['id']); ?>">
