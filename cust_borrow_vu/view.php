                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('customers_list_cust_name_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['cust_name']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('customers_list_office_name_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['office_name']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('customers_list_phone_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['phone']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('customers_list_email_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['email']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('customers_list_address_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['address']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('ctp_orders_vu_list_total_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['total']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('cust_result_vu_list_pay_total_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['pay_total']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('cust_result_vu_list_rtotal_title'); ?> :</th>
