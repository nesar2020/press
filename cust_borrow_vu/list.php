        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <h3 class="record-title"><?php print_lang('cust_borrow_vu_list_title'); ?></h3>
                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link('cust_borrow_vu') ?>"><?php echo $field_name ?></a></li>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('cust_borrow_vu') ?>">&laquo; <?php print_lang('link_back'); ?></a>
                                    </li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="card animated fadeIn">
                            <div id="cust_borrow_vu-list-records">
                                    ...
                                    <table class="table  table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="shorttd"> <?php echo $data['phone']; ?> </td>
                                                <td class="shorttd"> <?php echo $data['address']; ?> </td>
                                                <td class="longtd"> <?php echo $data['total']; ?> </td>
                                                <td class="longtd"> <?php echo $data['pay_total']; ?> </td>
                                                <td class="longtd"> <?php echo $data['rtotal']; ?> </td>
                                ...
                                <div class="card-footer">
                                    ...
                                    $pager->page_name='cust_borrow_vu';
