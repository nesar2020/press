...
<section class="page">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <a href="<?php print_link("customers/view/$custid"); ?>" class="btn btn-md btn-outline-success">
            ...
            <div class="row ">
                ...
                <div class="col-sm-3 comp-grid">
                    ...
                    <a style="display:none;"  class="btn btn btn-primary btn-block" href="<?php print_link("cust_payments/paymentwithid/$custid") ?>">
