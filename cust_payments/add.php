            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        ?>
                        <form id="cust_payments-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("cust_payments/add") ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="amount" value="<?php  echo $this->set_field_value('amount',''); ?>" type="number" placeholder="<?php echo "مقدار پول را وارد کنید"; ?>" step="any"  required="" name="amount" class="form-control " />
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input  id="cust_date" class="form-control datepicker" required=""
                                                            value="<?php  echo $this->set_field_value('cust_date',date("Y-m-d")); ?>" type="datetime" name="cust_date"
                                                            placeholder="<?php print_lang('cust_payments_add_cust_date_placeholder'); ?>"
                                                            data-enable-time="false"   data-date-format="Y-m-d" data-alt-format="F j, Y"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  name="cust_id" placeholder="<?php print_lang('prompt_select_placeholder'); ?>"    class="form-control">
                                                                ...
                                                                ?>
                                                                <option <?php echo $this->set_field_selected('cust_id',$val[0]) ?> value="<?php echo $val[0]; ?>">
