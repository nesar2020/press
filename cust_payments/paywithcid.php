                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <form id="cust_payments-add-form" role="form" enctype="multipart/form-data"
                              ...
                              action="<?php print_link("cust_payments/paywithcid/".$custid) ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="description"><?php echo "تفصیل "; ?>
                                                <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="description" value="<?php  echo $this->set_field_value('description',''); ?>"
                                                        type="text" placeholder="<?php echo "جزییات پرداخت را وارد کنید."; ?>"
                                                        step="any"   name="description" class="form-control " />
                                            </div>
