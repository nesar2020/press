        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <h3 class="record-title"><?php echo "رسیدات مشتری"; ?></h3>
                    
                </div>
                
                <div class="col-sm-3 comp-grid">
                    
                    <a style="display:none;" class="btn btn btn-primary btn-block" href="<?php print_link("cust_payments/add") ?>">
                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link('cust_payments') ?>"><?php echo $field_name ?></a></li>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('cust_payments') ?>">&laquo; <?php print_lang('link_back'); ?></a>
                                    </li>
                                ...
                                <div class="page-records table-responsive">
                                    ...
                                    <div class="card-footer">
                                        <div class="">  
                                            ...
                                            <button data-prompt-msg="Are you sure you want to delete these records" data-url="<?php print_link("cust_payments/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
                                            ...
                                            <?php Html :: import_form('cust_payments/import_data' , get_lang('list_import_btn_text'), 'CSV , JSON'); ?>
