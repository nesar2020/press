                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('employees_list_emp_name_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['emp_name']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('employees_list_f_name_title'); ?> :</th>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('emp_result_vu_view_stotal_label'); ?> :</th>
                                        <td class="value"> <?php echo $data['stotal']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('emp_result_vu_view_ptotal_label'); ?> :</th>
                                        <td class="value"> <?php echo $data['ptotal']; ?> </td>
                                    </tr>
