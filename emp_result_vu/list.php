        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <h3 class="record-title"><?php print_lang('emp_result_vu_list_title'); ?></h3>
                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link('emp_result_vu') ?>"><?php echo $field_name ?></a></li>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('emp_result_vu') ?>">&laquo; <?php print_lang('link_back'); ?></a>
                                    </li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="card animated fadeIn">
                            <div id="emp_result_vu-list-records">
                                    ...
                                    <table class="table  table-striped table-sm">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th class="td-sno">#</th>
                                                <th > <?php print_lang('emp_result_vu_list_emp_name_title'); ?></th>
                                                <th > <?php print_lang('emp_result_vu_list_f_name_title'); ?></th>
                                                <th > <?php print_lang('customers_list_phone_title'); ?></th>
                                                <th > <?php print_lang('customers_list_address_title'); ?></th>
                                                <th > <?php echo "تاریخ شروع کار"; ?></th>
                                                <th > <?php echo "وظیفه"; ?></th>
                                                <th > <?php print_lang('emp_result_vu_list_stotal_title'); ?></th>
