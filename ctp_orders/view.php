        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title"><?php print_lang('btn_view');echo " ctp "; ?></h3>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('ctp_orders_list_date_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['date']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('ctp_orders_list_plate_type_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['plate_type']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('ctp_orders_list_plate_no_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['plate_no']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('ctp_orders_list_plate_price_title'); ?> :</th>
                                        <td class="value"> <?php echo $data['plate_price']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('ctp_orders_list_u_id_title'); ?> :</th>
                                        <td class="value">
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("ctp_orders/edit/$data[id]"); ?>">
