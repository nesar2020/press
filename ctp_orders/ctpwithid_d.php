            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        ?>
                        <form id="ctp_orders-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("ctp_orders/ctpwithid_d/".$custid) ?>" method="post">
                            <div class="card-body">
