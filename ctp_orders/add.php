        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title"><?php echo "افزودن فرمایش ctp جدید"; ?></h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        ?>
                        <form id="ctp_orders-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("ctp_orders/add") ?>" method="post">
                            <div class="card-body">
                                                ...
                                                <div class="form-group ">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  name="u_id" placeholder="<?php print_lang('prompt_select_placeholder'); ?>"    class="form-control">
                                                                        ...
                                                                        ?>
                                                                        <option <?php echo $this->set_field_selected('u_id',$val[0]) ?> value="<?php echo $val[0]; ?>">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input  id="amount" value="<?php  echo $this->set_field_value('amount',''); ?>" type="number" placeholder="<?php echo "مقدار پول را وارد کنید"; ?>" step="any"   name="amount" class="form-control " />
