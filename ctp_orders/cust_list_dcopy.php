...
<section class="page">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            ...
            <div class="row ">
                <div class="col-md-2">
                    <a href="<?php print_link("customers/list_d"); ?>" class="btn btn-md btn-outline-success">
                ...
                <div class="col-md-10">
                    <?php foreach($total_pay as $tp): ?>
                        <div class="row">
                            <div class="col-md-2">
                                <strong><?php echo "ارز : ".$tp['currency'];?></strong>
                            </div>
                            <div class="col-md-3">
                                <strong><?php echo " مجموع : ".number_format($tp['total'],2);?></strong>
                            </div>
                            <div class="col-md-3">
                                <strong><?php echo " مجموع رسید : ".number_format($tp['pay'],2);?></strong>
                            </div>
                            <div class="col-md-3">
                                <strong><?php echo " باقی : ".number_format(($tp['total']-$tp['pay']),2);?></strong>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
            ...
            <div class="row ">
                ...
                <div class="col-sm-3 comp-grid">
                    ...
                    <a  class="btn btn btn-primary btn-block" href="<?php print_link("ctp_orders/ctpwithid_d/$custid") ?>">
                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link("ctp_orders/cust_list/$custid") ?>"><?php echo $field_name ?></a></li>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link("ctp_orders/cust_list/$custid") ?>">&laquo; <?php print_lang('link_back'); ?></a>
                                    </li>
                                    ...
                                    <table class="table  table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-outline-success " title="<?php print_lang('btn_edit_tooltip'); ?>"
                                                           href="<?php print_link('cust_payments/paymentwithid/'.$data['u_id']."/".$data['id']."/ctp"); ?>">
                                                            <i class="material-icons"></i> <?php echo "رسید"; ?>
                                                        </a>
                                                        <a class="btn btn-sm btn-info " title="<?php print_lang('btn_edit_tooltip'); ?>" href="<?php print_link('ctp_orders/edit_d/'.$data['id']); ?>">
                                                        ...
                                                        <a class="btn btn-sm btn-danger recordDeletePromptAction"
                                                           ...
                                                           href="<?php print_link('ctp_orders/del/'.$data['id']."/cust_list_d/$custid"); ?>" data-prompt-msg="">
