        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title"><?php echo "پیش پرداخت جدید"; ?></h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        ...
                        ?>
                        <form id="emp_payments-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("emp_payments/paywithid/".$custid) ?>" method="post">
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input  id="p_date" class="form-control datepicker" required=""
                                                                value="<?php  echo $this->set_field_value('p_date',date("Y-m-d")); ?>" type="datetime" name="p_date" placeholder="<?php print_lang('emp_payments_add_p_date_placeholder'); ?>" data-enable-time="false"   data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
