        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 comp-grid">
                    <h3 class="record-title"><?php print_lang('emp_payments_list_title'); ?></h3>
                    
                </div>
                
                <div class="col-sm-3 comp-grid">
                    
                    <a  class="btn btn btn-primary btn-block" href="<?php print_link("emp_payments/add") ?>">
                        ...
                        <div class="">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item"><a class="text-capitalize" href="<?php print_link('emp_payments') ?>"><?php echo $field_name ?></a></li>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link("emp_payments/list_id/$empid") ?>">&laquo; <?php print_lang('link_back'); ?></a>
                                    </li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class="card animated fadeIn">
                            <div id="emp_payments-list-records">
                                ...
                                <div class="page-records table-responsive">
                                    <table class="table  table-striped table-sm">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th > <?php print_lang('emp_payments_list_p_date_title'); ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <th class="td-btn">
                                                        <a class="btn btn-sm btn-info " title="<?php print_lang('btn_edit_tooltip'); ?>" href="<?php print_link('emp_payments/edit/'.$data['id']); ?>">
                                    ...
                                    <div class="card-footer">
                                        <div class="">  
                                            ...
                                            <button data-prompt-msg="Are you sure you want to delete these records" data-url="<?php print_link("emp_payments/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
                                            ...
                                            <?php Html :: import_form('emp_payments/import_data' , get_lang('list_import_btn_text'), 'CSV , JSON'); ?>
